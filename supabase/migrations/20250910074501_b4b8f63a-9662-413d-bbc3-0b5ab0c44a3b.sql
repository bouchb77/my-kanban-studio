...
create policy if not exists "Public can read tasks (dev)"
  on public.tasks for select using (true);

create policy if not exists "Public can insert tasks (dev)"
  on public.tasks for insert with check (true);

create policy if not exists "Public can update tasks (dev)"
  on public.tasks for update using (true) with check (true);

create policy if not exists "Public can delete tasks (dev)"
