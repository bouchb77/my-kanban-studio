-- Modifier la fonction pour inclure TOUTES les entreprises (avec ou sans coordonnées GPS)
...
BEGIN
  ...
  WITH company_orders AS (
    ...
    -- SUPPRESSION du filtre sur les coordonnées GPS
...
inclut TOUTES les entreprises (avec ou sans coordonnées GPS), la prochaine date de renouvellement et détecte les formations.';