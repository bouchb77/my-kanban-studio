-- Correction de la fonction get_company_stats_optimized pour inclure toutes les entreprises
-- et ajouter le nombre de commandes + montant moyen
...
BEGIN
  ...
  -- Retourner TOUTES les entreprises, pas seulement celles avec commandes
  -- Filtrer uniquement par le seuil max sur les montants annuels
  WHERE co.year_2023 <= max_threshold
