-- Ajouter les colonnes manquantes : date de formation, date rapport SIPI
...
BEGIN
  ...
  training_check AS (
    -- Détection des formations avec date de dernière commande formation
    SELECT 
      c.sipi_number,
