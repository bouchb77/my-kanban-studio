-- Corriger la fonction pour ne regarder que l'année de commande pour les formations payantes
...
BEGIN
  ...
  combined_data AS (
    -- Companies with paid orders (formation payante) - basé uniquement sur année de commande
    SELECT 
      sc.sipi_number,
      sc.company_name,
      sc.report_date,
